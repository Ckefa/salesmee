...
func brandHeader(gradient string) string {
	return fmt.Sprintf(`<tr style="background: %s;"><td style="background: #ffffff; padding: 12px 32px; text-align: center;" bgcolor="#ffffff"><img src="%s" alt="SalesMee" style="height: 28px; width: auto; display: block; margin: 0 auto;"></td></tr>`, gradient, AppURL("/static/images/salesmee.svg"))
}
